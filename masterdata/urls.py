...
from .views import (
    ...
    InventoryProductListView,InventoryProductDetailAjaxView,InventoryProductUpdateView,
    ...
    CustomerSearchAjaxView,
    HallSearchAjaxView, SenderSearchAjaxView, ProductSearchAjaxView,
...
urlpatterns = [
    ...
    path('inventory-product/', InventoryProductDetailAjaxView.as_view(), name='inventory-product-detail'),

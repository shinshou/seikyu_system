...
from .models import Customer, Hall, Sender, Product, InventoryProduct
...
class CustomerFilter(django_filters.FilterSet):
    ...
    def filter_by_keyword(self, queryset, name, value):
        queryset = queryset.filter(
            ...
            Q(mailaddress__icontains=value) |
...
class InventoryProductFilter(django_filters.FilterSet):
    ...
    def __init__(self, *args, **kwargs):
        super(InventoryProductFilter, self).__init__(*args, **kwargs)
        self.filters['product'].field.widget.attrs.update({'class': 'selectboxit selectbox selectboxit-btn'})

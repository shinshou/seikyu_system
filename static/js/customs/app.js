...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var lang = "ja"; // $('input[name="selected-lang"]').val();
    ...
    $('button[name="add_product_btn"]').click(function (e) {
        ...
        var value = $('select.select-invoice-product').val();
        if (value == "") {
        ...
        var data = $('select.select-invoice-product').select2('data');
        var product = $('select.select-invoice-product').find(':selected').data('name');;
        $('select.select-invoice-product').val(null).trigger('change');

...
class TraderSalesInvoiceViewOnly(AdminLoginRequiredMixin, View):
    def post(self, *args, **kwargs):
        ...
        ws.write_merge(10, 10, 5, 10, "〒550-0015　大阪府大阪市西区南堀江3-3-9-4F", font_11_left)

        ws.row(11).height = height_16_5
        ws.write_merge(11, 11, 5, 10, "TEL 06-4394-7513  FAX 06-4394-7514", font_11_left)
        ...
        ws.write_merge(row_no, row_no, 7, 8, '小計(うち10％対象)', subtotal_label_style)
        ...
        ws.write_merge(row_no, row_no, 0, 1, '適格事業者登録番号', transfer_account_style)
        ws.write_merge(row_no, row_no, 2, 10, 'T5-1200-0120-7338', font_11_left_with_border)
        row_no += 1
...
class TraderSalesInvoiceView(AdminLoginRequiredMixin, View):
    def post(self, *args, **kwargs):
        ...
        sender_table_title = ''
        if shipping_method == 'D': sender_table_title = '【商品発送先】'
        if shipping_method == 'R': sender_table_title = '【商品引取先】'
        if shipping_method == 'C': sender_table_title = '【商品保管先】'
        if shipping_method == 'B': sender_table_title = '【商品発送先】'

        ws.row(row_no).height = int(20 * 11.45)
        # ws.write_merge(row_no, row_no, 0, 5, '【商品発送先】', sender_table_title_style)
        ws.write_merge(row_no, row_no, 0, 5, sender_table_title, sender_table_title_style)
        ...
        # ws.write_merge(row_no, row_no, 0, 5, '〒550-0015　大阪府大阪市西区南堀江3-3-9-4F', seal_address_tel_style)
        ws.write_merge(row_no, row_no, 6, 10, '〒550-0015　大阪府大阪市西区南堀江3-3-9-4F', seal_address_tel_style1)
        row_no += 1
        ...
        # ws.write_merge(row_no, row_no, 0, 5, 'TEL 06-4394-7513 FAX 06-4394-7514', seal_address_tel_style)
        ws.write_merge(row_no, row_no, 6, 10, 'TEL 06-4394-7513 FAX 06-4394-7514', seal_address_tel_style)
        row_no += 1
        ...
        ws.write(row_no, 7, 'FAX 06-4394-7514', font_14_left1)
        row_no += 1
...
class TraderPurchasesInvoiceView(AdminLoginRequiredMixin, View):
    def post(self, *args, **kwargs):
        ...
        sender_table_title2 = ''
        if shipping_method == 'D': sender_table_title2 = '【商品発送先】'
        if shipping_method == 'R': sender_table_title2 = '【商品引取先】'
        if shipping_method == 'C': sender_table_title2 = '【商品保管先】'
        if shipping_method == 'B': sender_table_title2 = '【商品発送先】'

        ws.row(row_no).height = int(20 * 11.45)
        ws.write_merge(row_no, row_no, 0, 5, sender_table_title2, sender_table_title_style)
        ws.write_merge(row_no, row_no, 6, 10, '【書類発送先】', sender_table_title_style)
        row_no += 1
        ...
        ws.write_merge(row_no, row_no, 0, 5, '〒550-0015　大阪府大阪市西区南堀江3-3-9-4F', seal_address_tel_style1)
        row_no += 1
...
class HallSalesInvoiceView(AdminLoginRequiredMixin, View):
    def post(self, *args, **kwargs):
        ...
        ws.write_merge(8, 8, 5, 10, '〒550-0015　大阪府大阪市西区南堀江3-3-9-4F', F11)
        ws.write_merge(9, 9, 5, 9, 'TEL: 06-4394-7513', F11)
        ws.write(10, 4, '㊞', F11)
        ws.write_merge(10, 10, 5, 9, 'FAX: 06-4394-7514', F11)
        ws.write(10, 10, '㊞', F11)
        ...
        ws.write_merge(36, 36, 7, 8, '小計(うち10％対象)', TTL_CENTER)
        ...
        ################################# Last Table ################################
        ws.write_merge(49, 50, 0, 1, '振込先口座', TTL_THIN_CENTER)
        ws.write_merge(49, 49, 2, 10, '関西みらい銀行　堀江支店(118)　普通　0076109　バッジオカブシキガイシャ', TTR_THIN)
        ws.write_merge(50, 50, 2, 10, None, TR_THIN)
        ws.write_merge(51, 51, 0, 1, '適格事業者登録番号', TTL_THIN_CENTER)
        ws.write_merge(51, 51, 2, 10,'T5-1200-0120-7338', TR_THIN)
...
class HallPurchasesInvoiceView(AdminLoginRequiredMixin, View):
    def post(self, *args, **kwargs):
        ...
        ws.write_merge(row_no, row_no + 1, 1, 11, '〒550-0015 \n大阪府大阪市西区南堀江3-3-9-4F', xlwt.easyxf('font: height 180, name ＭＳ 明朝; align: vert center, horiz center, wrap on;'))
        ...
        ws.write_merge(row_no + 4, row_no + 4, 1, 11, 'TEL　06-4394-7513', xlwt.easyxf('font: height 220, name ＭＳ 明朝; align: vert center, horiz center, wrap on;'))
        ws.write_merge(row_no + 5, row_no + 5, 1, 11, 'FAX　06-4394-7514', xlwt.easyxf('font: height 220, name ＭＳ 明朝; align: vert center, horiz center, wrap on;'))

...
class EstimateListingSearchForm(forms.Form):
    estimate_id = forms.CharField(required=False)
    ...
    issue_date_from = forms.DateField(input_formats=INPUT_FORMATS, required=False)
    issue_date_to = forms.DateField(input_formats=INPUT_FORMATS, required=False)
...
class InvoiceListingSearchForm(forms.Form):
    invoice_id = forms.CharField(required=False)
    created_at = forms.DateField(input_formats=INPUT_FORMATS, required=False)
    created_at_to = forms.DateField(input_formats=INPUT_FORMATS, required=False)
    billing_date_from = forms.DateField(input_formats=INPUT_FORMATS, required=False)
    billing_date_to = forms.DateField(input_formats=INPUT_FORMATS, required=False)
    customer = forms.CharField(required=False)
    # name = forms.CharField(required=False)
    # person_in_charge = forms.CharField(required=False)
    # inventory_status = forms.CharField(required=False)
    
class DeliveryListingSearchForm(forms.Form):
    delivery_id = forms.CharField(required=False)
    created_at = forms.DateField(input_formats=INPUT_FORMATS, required=False)
    created_at_to = forms.DateField(input_formats=INPUT_FORMATS, required=False)
    issue_date_from = forms.DateField(input_formats=INPUT_FORMATS, required=False)
    issue_date_to = forms.DateField(input_formats=INPUT_FORMATS, required=False)

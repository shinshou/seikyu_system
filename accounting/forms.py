...
class SearchForm(forms.Form):
    ...
    sale_print_date = forms.DateField(input_formats=INPUT_FORMATS, required=False)
    purchase_print_date = forms.DateField(input_formats=INPUT_FORMATS, required=False)
